...
{
    public class CsvPKey : IComparable
    {
        ...
        public CsvPKey(ISerializableObject iso, String target)
        {
            _type = iso.GetType();
        ...
        public String ToSqlString()
        {
            ...
            foreach (String s in keys)
            {
                ...
                b.Append(tmp[0]).Append("='").Append(tmp[1]).Append("'");
            }
        ...
        public static bool operator ==(CsvPKey a, CsvPKey b)
        {
            ...
            try
            {
                ...
                {
                    return
                        ((CsvPKey)a)._csvKey.Equals(b._csvKey) &&
                        ((CsvPKey)a)._type == b._type;
                }
            }
