    ...
    public partial class UserGui : Form
    {
        ...
        private void buttonConnectRepository_Click(object sender, EventArgs e)
        {
            if (repositoryConnected == false)
            {
                ...
                {
                    Cursor.Current = Cursors.WaitCursor;
                    repositorySerializer = new MS_SqlServerWASerializier(this.IPAddress + "," + this.IPPort, this.InitialCatalog,null);
        ...
        private void buttonChooseProject_Click(object sender, EventArgs e)
        {
            ...
            //sb.Append(" (Select ProjectID From ProjectUser Where LoginName='Simmel')");
            com.CommandText = sb.ToString();
            ...
            //if (profile == null)
            //{
            //    MessageBox.Show("Create new profile!");
            //    //->neues Profil erstellen
            //    if (createProfile() == true)
            //        enableActionButtons();
            //}
