...
{
    public class CollTypeStatus_Enum:ISerializableObject
    {
        ...
        //[OneToMany]
        //[JoinColums(DefColumn = "_Code", JoinColumn = "_TypeStatus")]
        ...
        public override string ToString()
        {
            ...
            {
                String text = "CollTypeStatus: " + this.DisplayText;
                return text;
            }
