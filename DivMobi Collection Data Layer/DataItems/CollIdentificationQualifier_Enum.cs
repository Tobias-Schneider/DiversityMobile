...
{
    public class CollIdentificationQualifier_Enum:ISerializableObject
    {
        ...
        //[OneToMany]
        //[JoinColums(DefColumn = "_Code", JoinColumn = "_IdentificationQualifier")]
        ...
        public CollIdentificationQualifier_Enum()
        {
        }
        ...
        public override string ToString()
        {
            ...
            {
                String text = "CollIdentificationQualifier: " + this.DisplayText;
                return text;
            }
