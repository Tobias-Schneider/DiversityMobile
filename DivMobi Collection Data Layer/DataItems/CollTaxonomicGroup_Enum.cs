...
{
    public class CollTaxonomicGroup_Enum : ISerializableObject
    {
    ...
    //    private IDirectAccessIterator<IdentificationUnit> _IdentificationUnits;
        ...
        //[OneToMany]
        //[JoinColums(DefColumn = "_Code", JoinColumn = "_ParentCode")]
        //private IDirectAccessIterator<CollTaxonomicGroup_Enum> _CollTaxonomicGroups;

        //[ManyToOne]
        //[MappedBy("_CollTaxonomicGroups")]
        //private CollTaxonomicGroup_Enum _CollTaxonomicGroup;

        #region Default constructor

        public CollTaxonomicGroup_Enum()
        {
